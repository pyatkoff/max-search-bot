...
checkConversationUi('composer autosizes and supports explicit keyboard submit',strpos($js,"reply.addEventListener('input',autoGrow)")!==false&&strpos($js,"e.metaKey||e.ctrlKey")!==false&&strpos($js,'form.requestSubmit()')!==false);

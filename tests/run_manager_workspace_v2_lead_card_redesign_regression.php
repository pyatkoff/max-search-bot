...
lcCheck('stage mutation reports success only after refresh',strpos($js,"setSalesSaveState('Этап сохранён','success')")!==false&&strpos($js,'refreshLeadData({refreshInbox:true})')!==false);
...
lcCheck('lead card mutations keep stability refresh boundary',substr_count($js,'refreshLeadData({refreshInbox:true})')>=4&&strpos($js,'WorkspaceV2Conversation?.open')===false);

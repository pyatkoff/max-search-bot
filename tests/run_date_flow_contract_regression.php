...
dateContractCheck('technical display window is not customer flexibility', ($contract['state']['flexibility_policy'] ?? null) === 'customer_date_flexibility_is_unknown_unless_explicitly_supplied_and_must_not_be_inferred_from_the_technical_plus_or_minus_3_day_window');

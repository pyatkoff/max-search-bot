...
mrCheck('manager summary delegates already-hydrated attachments to canonical context owner',strpos($managerApiSource,"'attachments'=>ManagerHandoffContextService::customerAttachments($d['messages'])")!==false,true);

...
$ordered=['assets/workspace-v2.js','assets/workspace-v2-inbox.js','assets/workspace-v2-filters.js','assets/workspace-v2-pipeline.js','assets/workspace-v2-stage-history.js','assets/workspace-v2-lead-card.js','assets/workspace-v2-conversation.js','assets/workspace-v2-shift.js','assets/workspace-v2-bootstrap.js'];
...
splitCheck('pipeline module owns sales tags and outcome persistence only',strpos($pipeline,'window.WorkspaceV2Pipeline=')!==false&&strpos($pipeline,"pipe('set_tags'")!==false&&strpos($pipeline,"pipe('set_outcome'")!==false&&strpos($pipeline,"pipe('set_stage'")!==false&&strpos($pipeline,'FILTER_STORAGE_KEY')===false&&strpos($pipeline,'setTaskShortcut')===false);

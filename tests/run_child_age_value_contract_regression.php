...
$accepted = [
    ...
    ['live double-space ages', '10  14', 2, [10, 14]],
    ['repeated internal spaces', '3   7', 2, [3, 7]],
    ['explicit zero with repeated spaces', '0  7', 2, [0, 7]],
    ['three ages with repeated spaces', '3  7   14', 3, [3, 7, 14]],
...
$rejected = [
    ...
    ['spaces cannot invent a third zero-age child', '3  7', 3],
    ['live ages do not fill a missing third child', '10  14', 3],
    ['repeated spaces do not waive age bounds', '10  18', 2],
    ['birth years remain rejected', '2016, 2012', 2],
    ['wrong count', '3', 2],
    ['out of range', '3, 18', 2],

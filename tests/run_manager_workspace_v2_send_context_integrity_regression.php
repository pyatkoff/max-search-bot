...
sciCheck('text send captures source conversation before await',strpos($conversation,'const target=Number(S.current||0),generation=openSeq,owner=replySessionOwner,draftText=')!==false&&strpos($conversation,"api('send',{conversation_id:target,text})")!==false);

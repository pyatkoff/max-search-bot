...
navSaveCheck('slice preserves protected product boundaries',stripos($conversation.$lead.$tasks.$pipeline,'metrika')===false&&stripos($conversation.$lead.$tasks.$pipeline,'routing_bonus')===false&&stripos($conversation.$lead.$tasks.$pipeline,'set_working')===false&&strpos($conversation.$lead.$tasks.$pipeline,'LeadDestination')===false);

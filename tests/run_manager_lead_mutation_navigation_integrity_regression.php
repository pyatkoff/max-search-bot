...
navSaveCheck('outcome finally does not mutate a newly rendered button',strpos($pipeline,'if(button?.isConnected){button.disabled=false')!==false&&strpos($pipeline,"const next=$('saveOutcome')")===false);

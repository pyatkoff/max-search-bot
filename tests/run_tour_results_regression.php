...
$expectedMessage = "🔥 <b>Поиск туров готов</b>\n\n"
    . "На сайте автоматически подставятся город вылета, направление, дата, ночи и состав туристов. "
    . "Если вы указали категорию отеля и питание, они тоже попадут в фильтры. Бюджет и другие пожелания к отелю или отдыху автоматически в фильтры сайта не переносятся — они сохранены для менеджера.\n\n"
...
trCheck('final message names proven auto-filled trip fields',str_contains($model['text'],'город вылета, направление, дата, ночи и состав туристов'),true);
trCheck('final message names supported explicit hotel filters',str_contains($model['text'],'категорию отеля и питание, они тоже попадут в фильтры'),true);
trCheck('final message does not promise manager-only wishes as website filters',str_contains($model['text'],'Бюджет и другие пожелания к отелю или отдыху автоматически в фильтры сайта не переносятся'),true);

...
mutationInventoryCheck(($current['summary']['caller_groups'] ?? 0) === 26, 'inventory owns the exact current caller-group baseline');
mutationInventoryCheck(($current['summary']['occurrences'] ?? 0) === 46, 'inventory owns the exact current occurrence baseline');

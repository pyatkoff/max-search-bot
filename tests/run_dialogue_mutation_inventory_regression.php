...
mutationInventoryCheck(($current['summary']['caller_groups'] ?? 0) === 27, 'inventory owns the exact current caller-group baseline');
mutationInventoryCheck(($current['summary']['occurrences'] ?? 0) === 47, 'inventory owns the exact current occurrence baseline');

...
handoffInventoryCheck(($current['summary']['caller_groups'] ?? 0) === 15, 'inventory owns the exact current caller-group baseline');
handoffInventoryCheck(($current['summary']['occurrences'] ?? 0) === 17, 'inventory owns the exact current occurrence baseline');

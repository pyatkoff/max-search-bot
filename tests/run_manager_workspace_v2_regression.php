...
mw2Check('workspace list shows lead-centric metadata',strpos($ui,'c.lead_stage?.display_name')!==false&&strpos($ui,'c.lead_tags')!==false&&strpos($ui,'c.lead_outcome')!==false&&strpos($ui,'c.trip_summary')!==false&&strpos($ui,'c.unread_count')!==false&&strpos($ui,'c.origin_label')!==false&&strpos($ui,'c.awaiting_first_reply')!==false);

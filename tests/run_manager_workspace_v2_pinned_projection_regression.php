...
ppCheck('presentation requests pin mutation only through canonical manager API',strpos($inboxJs,"pipe('set_task_pinned'")===false&&strpos($kanbanJs,"pipe('set_task_pinned'")!==false&&strpos($kanbanJs,'LeadTaskService::setPinned')===false&&strpos($kanbanJs,'UPDATE lead_tasks')===false);

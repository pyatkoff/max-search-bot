...
ppCheck('kanban shows when more open tasks exist behind the projected task',strpos($kanbanTasksJs,'function extraTaskSignal(c)')!==false&&strpos($kanbanTasksJs,'c.open_task_count')!==false&&strpos($kanbanTasksJs,'Ещё ${count} открытых')!==false&&strpos($kanbanTasksJs,'${extraTaskSignal(c)}')!==false);

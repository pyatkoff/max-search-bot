...
nCheck('inline push setup repairs stale VAPID subscription',strpos($js,'reg.pushManager.getSubscription()')!==false&&strpos($js,'sameBytes(sub.options.applicationServerKey,key)')!==false&&strpos($js,'await sub.unsubscribe()')!==false);
...
nCheck('push setup reports denied and failed states inline',strpos($js,"permission_denied:'Разрешение на уведомления не выдано'")!==false&&strpos($js,"enable_failed:'Не удалось включить уведомления'")!==false&&strpos($js,"Подключаем…")!==false);

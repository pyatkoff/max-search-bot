...
foreach(['healthy_cutover_dual','https://app.anytoour.ru/webhook.php','https://app.anytoour.ru/webhook.php','unexpected_subscription_urls'] as $needle){if(!str_contains($activate,$needle)){fwrite(STDERR,"Cron activation does not recognize safe MAX cutover state: {$needle}\n");exit(1);}}

...
inboxCheck('pipeline API applies source id without changing routing',strpos($pipelineApi,'$sourceId=max(0,(int)')!==false&&strpos($pipelineApi,"data['source_id']")!==false&&strpos($pipelineApi,"r['source_id']")!==false&&strpos($pipelineApi,'===$sourceId')!==false);

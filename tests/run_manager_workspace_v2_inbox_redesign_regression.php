...
inboxCheck('lead cards expose responsible manager or explicit unassigned owner',strpos($js,"manager||'Не назначен'")!==false&&strpos($js,"leadManagerSignal${manager?'':' unassigned'}")!==false);

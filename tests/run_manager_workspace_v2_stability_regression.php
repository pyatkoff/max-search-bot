...
stableCheck('manager index canonicalizes explicit index.php to directory root',strpos($index,"preg_match('~/index\\.php$~'")!==false&&strpos($index,"header('Location: '.\$target,true,302)")!==false&&strpos($index,"require __DIR__.'/workspace-v2.php'")!==false);

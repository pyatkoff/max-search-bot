...
stableCheck('workspace keyboard shortcuts are isolated in a dedicated interface module',strpos($index,"workspaceAsset('workspace-v2-shortcuts.js')")!==false&&strpos($shortcuts,'window.WorkspaceV2Shortcuts=')!==false&&strpos($shortcuts,"document.addEventListener('keydown',onKeydown)")!==false&&strpos($shortcuts,'replaceChildren')===false);

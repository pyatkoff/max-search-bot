...
stableCheck('workspace bootstrap only starts the canonical workspace',strpos($bootstrap,'WorkspaceV2?.boot()')!==false&&strpos($bootstrap,'workspace-v2-lead-summary-copy.js')===false&&strpos($bootstrap,'WorkspaceV2LeadSummaryCopy')===false);

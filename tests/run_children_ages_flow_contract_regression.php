...
childrenAgesContractCheck('legacy parser parity contract is executable but not wired', ($contract['child_ages']['parser_parity_contract'] ?? null) === 'ChildAgeValueContract::parseLegacyInput' && strpos($valueContract, 'public static function parseLegacyInput') !== false && strpos($handler, 'ChildAgeValueContract') === false);

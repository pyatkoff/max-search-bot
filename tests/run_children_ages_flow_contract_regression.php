...
childrenAgesContractCheck('child-age runtime remains blocked after executable contract', empty($contract['migration_readiness']['child_age_message']['runtime_migration_allowed']) && str_contains((string)($contract['migration_readiness']['child_age_message']['blocker'] ?? ''), 'runtime wiring remains disabled') && count((array)($contract['migration_readiness']['child_age_message']['completed_before_runtime'] ?? [])) === 2 && count((array)($contract['migration_readiness']['child_age_message']['required_before_runtime'] ?? [])) === 2);

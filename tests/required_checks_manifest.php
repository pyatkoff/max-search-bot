...
return [
    ...
    'dialogue' => [
        ...
        'php tests/run_followup_manager_guard_regression.php',
        'php tests/run_post_tour_help_regression.php',
        ...
        'php tests/run_departure_city_free_text_application_regression.php',
    ...
    'manager' => [
        ...
        'php tests/run_manager_conversation_access_policy_regression.php',

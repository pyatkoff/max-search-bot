...
checkRouting('routing edit cancellation is client-side reset only',strpos($js,"$('cancelGroupEdit').onclick=()=>resetGroupForm()")!==false&&strpos($js,"$('cancelSourceEdit').onclick=()=>resetSourceForm()")!==false);

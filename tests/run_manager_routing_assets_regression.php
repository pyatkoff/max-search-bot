...
checkRouting('routing edit cancellation is client-side reset only and save guarded',strpos($js,"cancelGroupEdit').onclick=()=>{if(editorBusy('group'))return;resetGroupForm()}")!==false&&strpos($js,"cancelSourceEdit').onclick=()=>{if(editorBusy('source'))return;resetSourceForm()}")!==false&&strpos($js,"api('save_group'",strpos($js,"cancelGroupEdit').onclick"))===false&&strpos($js,"api('save_source'",strpos($js,"cancelSourceEdit').onclick"))===false);

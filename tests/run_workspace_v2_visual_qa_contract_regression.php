...
vqCheck('fixtures have no real production endpoints',strpos($fixture,'anytour.online')===false&&strpos($fixture,'api.php')===false&&strpos($fixture,'pipeline-api.php')===false&&strpos($kanbanFixture,'anytour.online')===false&&strpos($kanbanFixture,'api.php')===false&&strpos($kanbanFixture,'pipeline-api.php')===false&&strpos($activityFixture,'anytour.online')===false&&strpos($activityFixture,'api.php')===false&&strpos($activityFixture,'pipeline-api.php')===false&&strpos($startupFixture,'anytour.online')===false&&strpos($startupFixture,'api.php')===false&&strpos($startupFixture,'pipeline-api.php')===false&&strpos($adminFixture,'anytour.online')===false&&strpos($adminFixture,'api.php')===false);

...
tmCheck('task rows always expose responsible manager or unassigned state',strpos($tasks,"task.assigned_manager_name||''")!==false&&strpos($tasks,"||'Не назначен'")!==false&&strpos($tasks,'· 👤 ${esc(owner)}')!==false);

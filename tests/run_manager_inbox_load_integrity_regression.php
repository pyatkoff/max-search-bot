...
inboxLoadCheck('mine fallback eligibility is scoped to the captured request',strpos($js,"Number(j?.http_status||0)>=500&&canUseMineFallback(payload)")!==false&&strpos($js,"api('list',{queue:'mine',project_key:payload.project_key})")!==false);

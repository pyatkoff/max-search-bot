...
inboxLoadCheck('mine fallback remains available only after pipeline server failure',strpos($js,"S.queue==='mine'&&Number(j?.http_status||0)>=500")!==false&&strpos($js,"api('list',{queue:'mine',project_key:'*'})")!==false);

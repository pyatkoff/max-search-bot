...
kbCheck('column headers retain actionable and sales summaries',strpos($kanban,'function columnSummary')!==false&&strpos($kanban,'awaiting_first_reply')!==false&&strpos($kanban,'next_task_overdue')!==false&&strpos($kanban,'unread_count')!==false&&strpos($kanban,'function columnSalesTotal')!==false&&strpos($kanban,'lead_sale_amount')!==false&&strpos($kanban,'Продажи ${sales}')!==false);

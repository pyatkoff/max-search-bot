...
kbCheck('stage mutation recovers after rejected request',strpos($kanban,"try{j=await pipe('set_stage'")!==false&&strpos($kanban,"catch(e){select.value=previous;select.disabled=false;alert('Не удалось изменить этап');return}")!==false);

...
kbCheck('column headers surface open leads missing a next task',strpos($kanban,"else if(String(c.lead_outcome||'open')==='open')missing++")!==false&&strpos($kanban,'`${missing} без задачи`')!==false);

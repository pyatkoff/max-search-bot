...
closedTaskCheck('no technical status or routing semantics introduced',strpos($tasks,"set_status")===false&&stripos($tasks,'routing')===false&&stripos($tasks,'is_working')===false);

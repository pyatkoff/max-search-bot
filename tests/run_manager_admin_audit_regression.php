...
maaCheck('project and manager edit mode are explicit and accessible',strpos($editSafety,"ensureModeStatus(projectCard,'projectEditMode')")!==false&&strpos($editSafety,"ensureModeStatus(managerCard,'managerEditMode')")!==false&&strpos($editSafety,"el.setAttribute('role','status')")!==false&&strpos($editSafety,"el.setAttribute('aria-live','polite')")!==false&&strpos($editSafety,"classList.toggle('editing',id>0)")!==false);
maaCheck('editing an existing record exposes a dedicated cancel action',strpos($editSafety,"cancelProjectEdit")!==false&&strpos($editSafety,"cancelManagerEdit")!==false&&strpos($editSafety,"classList.toggle('hidden',id<=0)")!==false);
...
maaCheck('admin edit controls stay synchronized after canonical successful save reset',strpos($editSafety,"new MutationObserver(syncProjectMode).observe(projectStatus")!==false&&strpos($editSafety,"new MutationObserver(syncManagerMode).observe(managerStatus")!==false);

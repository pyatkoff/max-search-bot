...
maaCheck('priority rule save is duplicate guarded and recoverable',strpos($js,"if($('saveRule').disabled)return")!==false&&strpos($js,"withBusyButton('saveRule',true)")!==false&&strpos($js,"withBusyButton('saveRule',false)")!==false&&strpos($js,"setFormStatus('ruleFormStatus'")!==false);

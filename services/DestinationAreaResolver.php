...
class DestinationAreaResolver
{
    ...
    private static function tokens($text)
    {
        ...
        $stop = [
            ...
            'на','в','из','и','или','для','с','со','около','район','курорт','начале','середине','конце','октябре','сентябре','ноябре','декабре','январе','феврале','марте','апреле','мае','июне','июле','августе','двоих','троих','неделю','недели','ночей','дней',
            // Общие разговорные слова не являются туристическими зонами. Без этого
            // "куда можно?" могло совпасть с фрагментом названий мальдивских отелей
            // и ошибочно закрепить Мальдивы как destination.
            'куда','можно','какие','какой','какая','вариант','варианты','предложить','посоветуй','посоветуйте','лучше','хорошее','хороший','хорошую','теплую','теплое','теплый','теплое'
        ];

...
if($action==='edit_candidates'){
    $conversationId=(int)($data['conversation_id']??0);
    out(['ok'=>true,'messages'=>ManagerMessageEditService::editableForConversation($conversationId,(int)$m['id'])]);
}
